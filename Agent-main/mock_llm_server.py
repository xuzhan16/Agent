...
async def fake_completions(req: ChatCompletionRequest):
    ...
    elif "non_cs_filter" in combined_prompt:
        if any(keyword in combined_prompt for keyword in ["化学", "化工", "食品", "微生物", "生物", "制药", "机械", "土木", "建筑", "护理", "销售", "财务"]):
            content_to_return = '{"is_cs_related": false, "confidence": 0.92, "reason": "岗位描述更偏非计算机专业或传统业务职能。"}'
        else:
            content_to_return = '{"is_cs_related": true, "confidence": 0.88, "reason": "岗位名称与描述更符合计算机/信息技术相关方向。"}'
